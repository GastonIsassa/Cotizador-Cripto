const criptomoneadasSelect = document.querySelector('#criptomonedas');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    criptomoneadasSelect.addEventListener('change', leerValor);
...
function selectCriptomonedas(criptomonedas) {
    criptomonedas.forEach(cripto => {
        ...
        criptomoneadasSelect.appendChild(option);
    })
